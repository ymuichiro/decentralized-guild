...
export function ReceiptTypeEnumFromJSON(json) {
    return ReceiptTypeEnumFromJSONTyped(json, false);
}
export function ReceiptTypeEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function ReceiptTypeEnumToJSON(value) {
    return value;
}
