...
export function TransactionTypeEnumFromJSON(json) {
    return TransactionTypeEnumFromJSONTyped(json, false);
}
export function TransactionTypeEnumFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
export function TransactionTypeEnumToJSON(value) {
    return value;
}
