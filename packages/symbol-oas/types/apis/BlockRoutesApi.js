...
var BlockRoutesApi = /** @class */ (function (_super) {
     ...
     */
    BlockRoutesApi.prototype.getBlockByHeightRaw = function (requestParameters, initOverrides) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/blocks/{height}".replace("{".concat('height', "}"), encodeURIComponent(String(requestParameters.height))),
                                method: 'GET',
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return BlockInfoDTOFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get block information
     */
    BlockRoutesApi.prototype.getBlockByHeight = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBlockByHeightRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     */
    BlockRoutesApi.prototype.getMerkleReceiptsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/blocks/{height}/statements/{hash}/merkle"
                                    .replace("{".concat('height', "}"), encodeURIComponent(String(requestParameters.height)))
                                    .replace("{".concat('hash', "}"), encodeURIComponent(String(requestParameters.hash))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            }, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return MerkleProofInfoDTOFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get the merkle path for a given a receipt statement hash and block
     */
    BlockRoutesApi.prototype.getMerkleReceipts = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getMerkleReceiptsRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    BlockRoutesApi.prototype.getMerkleTransactionRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get the merkle path for a given a transaction and block
     */
    BlockRoutesApi.prototype.getMerkleTransaction = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getMerkleTransactionRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Search blocks
     */
    BlockRoutesApi.prototype.searchBlocksRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return BlockPageFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Search blocks
     */
    BlockRoutesApi.prototype.searchBlocks = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.searchBlocksRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
