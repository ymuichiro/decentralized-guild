...
var MetadataRoutesApi = /** @class */ (function (_super) {
     ...
     */
    MetadataRoutesApi.prototype.getMetadataRaw = function (requestParameters, initOverrides) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                path: "/metadata/{compositeHash}".replace("{".concat('compositeHash', "}"), encodeURIComponent(String(requestParameters.compositeHash))),
                                method: 'GET',
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return MetadataInfoDTOFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get metadata information
     */
    MetadataRoutesApi.prototype.getMetadata = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getMetadataRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
     ...
     */
    MetadataRoutesApi.prototype.getMetadataMerkleRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headerParameters = {};
                        return [4 /*yield*/, this.request({
                                path: "/metadata/{compositeHash}/merkle".replace("{".concat('compositeHash', "}"), encodeURIComponent(String(requestParameters.compositeHash))),
                                method: 'GET',
                                headers: headerParameters,
                                query: queryParameters,
                            }, initOverrides)];
     ...
     * Get metadata merkle information
     */
    MetadataRoutesApi.prototype.getMetadataMerkle = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getMetadataMerkleRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     */
    MetadataRoutesApi.prototype.searchMetadataEntriesRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return MetadataPageFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Search metadata entries
     */
    MetadataRoutesApi.prototype.searchMetadataEntries = function (requestParameters, initOverrides) {
        if (requestParameters === void 0) { requestParameters = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.searchMetadataEntriesRaw(requestParameters, initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
