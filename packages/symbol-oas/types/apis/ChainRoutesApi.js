...
var ChainRoutesApi = /** @class */ (function (_super) {
     ...
     */
    ChainRoutesApi.prototype.getChainInfoRaw = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return ChainInfoDTOFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get the current information of the chain
     */
    ChainRoutesApi.prototype.getChainInfo = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getChainInfoRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
